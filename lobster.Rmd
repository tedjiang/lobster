...
#two-sample t-test
#Ho: The lobster size of 2002 and 2018 do not vary significantly.
#HA: The lobster size of 2002 and 2018 vary significantly.
iv_ttest <- iv %>% 
  filter (YEAR == 2012 | YEAR == 2017) %>% 
  t.test(SIZE ~ YEAR, var.equal = TRUE,data = .)
iv_ttest
#p-value is more than 0.05, so we have to retain the null hypothesis
#The lobster size of 2002 and 2018 do not vary significantly
...
#The lobster size of 2002 and 2018 vary significantly
...
#Based on the two-sample t-test in five sites, excpet the Mohawk Reef, there is no significant difference in lobster size in year 2012 and 2017....
```
